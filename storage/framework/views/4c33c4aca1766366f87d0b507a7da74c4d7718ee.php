...
<html lang="en" class="h-100">
  <head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?>-NeoRestaurant</title>
...
<meta name="theme-color" content="#563d7c">
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <a href="<?php echo e(route('users.index')); ?>">
        ...
        <img  style="width:70%;" src="<?php echo e(asset('img/logo.png')); ?>" alt=""/>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="<?php echo e(route('users.index')); ?>">Usuarios <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="<?php echo e(route('users.nuevo')); ?>">Crear Usuarios <span class="sr-only">(current)</span></a>
        </li>
      </ul>
...
<?php /**PATH C:\xampp\htdocs\Laravel\NeoRestaurant\resources\views/layoutRegistro.blade.php ENDPATH**/ ?>